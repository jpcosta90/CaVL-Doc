...
\begin{table}[h]
    ...
    \midrule
    \textit{Euclidean} \\
    Contrastive Loss & 2.58 & 27.99 \\
    Triplet Loss & \textbf{1.48} & \textbf{22.99} \\
    \addlinespace
...
\textbf{CaVL-Doc (Best Configuration)} & \textbf{Embedded} & \textbf{1.48} & \textbf{22.99} \\
\bottomrule
\end{tabularx}
